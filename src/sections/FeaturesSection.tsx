...
const features = [
  {
    ...
    desc: 'Cada métrica importa. Desde repeticiones hasta variabilidad de ingesta calórica, desde evaluaciones físicas hasta análisis de emociones, nuestro sistema de tracking aprende de ti y se adapta.',
  },
  {
    icon: FlaskConical,
    ...
    desc: 'No seguimos modas. Seguimos evidencia. Cada protocolo está respaldado por literatura científica real. Cada app esta desarrollada por profesionales de la salud y el deporte.',
  },
  {
    icon: Smartphone,
    ...
    desc: 'Experiencia fluida que no te distrae de lo importante: tus entrenamientos, tus comidas, tu evolución emocional.',
  },
  {
    icon: Users,
