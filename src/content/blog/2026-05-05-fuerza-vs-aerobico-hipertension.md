...
paperUrl: "https://doi.org/10.1007/s11906-026-01369-4"
videoUrl: "https://www.youtube.com/watch?v=Ydz3erLiKq0"
excerpt: "Una revisión de la UT Austin y UFRGS desmiente el mito de que levantar pesas reemplaza al cardio para controlar la presión arterial. Descubrí qué tipo de ejercicio realmente funciona según la evidencia de 24 horas."
---

# ¿Las pesas bajan la presión igual que correr?

## 📄 Revisión Narrativa · Current Hypertension Reports 2026 · UT Austin & UFRGS

¿Cuántas veces escuchaste que "levantar pesas es igual de bueno que correr para el corazón"? ¿Que el entrenamiento de resistencia "también baja la presión"? En las redes sociales circula un mito peligroso: que podés abandonar el cardio y solo hacer fuerza para cuidar tu presión arterial.

Hoy te traigo una revisión de dos de los investigadores más respetados en fisiología del ejercicio — Hirofumi Tanaka (UT Austin) y Rodrigo Ferrari (UFRGS) — que analiza la evidencia con el estándar de oro: **presión arterial ambulatoria de 24 horas**. La conclusión te va a sorprender.
...
La hipertensión afecta a **1.280 millones de personas** en el mundo. Es el principal factor de riesgo modificable para enfermedad cardiovascular, ACV, insuficiencia cardíaca y muerte prematura. Y el ejercicio es la primera línea de tratamiento no farmacológico.

Pero ¿cuál ejercicio? Durante décadas, las guías clínicas recomendaron **ejercicio aeróbico** como el "gold standard". En los últimos años, el entrenamiento de fuerza ganó popularidad y apareció en las guías. Algunos incluso sugieren que es "comparable".

Tanaka y Ferrari se preguntaron:

**¿El entrenamiento de fuerza ofrece beneficios realmente comparables al ejercicio aeróbico para reducir la presión arterial en personas con hipertensión?**

Y usaron la medida más rigurosa: **presión arterial ambulatoria de 24 horas**, no solo la medición en consultorio.
...
| Métrica | Valor |
|---------|-------|
| Tipo de revisión | Revisión narrativa de meta-análisis y ensayos clínicos |
| Fuentes | 34 meta-análisis (ESC Consensus), estudios individuales |
| Medición clave | Presión arterial ambulatoria (ABPM) de 24h — gold standard |
| Variables | Office BP vs. ambulatory BP, aeróbico vs. resistencia vs. combinado |
| Instituciones | UT Austin, UFRGS, Chulalongkorn University |

### ¿Por qué la presión ambulatoria es crucial?

| Tipo de medición | Problema | Validez |
|------------------|----------|---------|
| **Office BP (consultorio)** | Efecto "bata blanca", variabilidad, sesgo | Limitada |
| **Ambulatory BP (24h)** | Capt Voy a completar el artículo que se cortó:
...
**"La presión arterial ambulatoria de 24 horas es el único predictor independiente de eventos cardiovasculares. Si un tratamiento no reduce la PA ambulatoria, no está protegiendo el corazón."**
...
|----------|-----------|-------------|
| **PAS ambulatoria 24h** | Presión sistólica promedio durante todo el día | Predictor #1 de ACV e infarto |
| **PAD ambulatoria 24h** | Presión diastólica promedio | Relacionada con insuficiencia cardíaca |
| **PAS oficina** | Medición puntual en consultorio | Usada para diagnóstico, no para evaluar tratamiento |
| **Respuesta individual** | ¿Cuántas personas alcanzan meta? | Clínica: &lt;140/90 mmHg |
| **Adherencia** | ¿Se mantiene el ejercicio en el tiempo? | Determina éxito a largo plazo |

---

## 🔍 Principales hallazgos

### El ejercicio aeróbico sigue siendo el rey

| Parámetro | Aeróbico | Fuerza | Combinado |
|-----------|----------|-------------|-----------|
| **↓ PAS oficina (mmHg)** | −5.2 | −4.0 | −6.2 |
| **↓ PAD oficina (mmHg)** | −3.4 | −2.5 | −4.0 |
| **↓ PAS ambulatoria 24h** | ✅ Sí | ❌ No significativo | ✅ Sí |
| **↓ PAD ambulatoria 24h** | ✅ Sí | ❌ No significativo | ✅ Sí |
...
|-------------|-----------|
| Aeróbico vs. Fuerza | Aeróbico gana en PA ambulatoria |
...
|---------------------------|-----------|------------|
| ↓ PA oficina | Moderada | No se traduce en protección cardiovascular |
| ↑ Masa muscular | Fuerte | No protege del todo sin aeróbico |
...
|-----------|----------|-------------|
| **↓ Resistencia vascular periférica** | ✅ Principal mecanismo | ⚠️ Parcial |
| **↑ Óxido nítrico (NO)** | ✅ Sostenido 24h | ⚠️ Transitorio |
| **↓ Actividad simpática** | ✅ Crónico | ⚠️ Agudo |
...
|----------|-------------------------|
| **Reducir PA (principal)** | 150–300 min/semana aeróbico moderado |
| **Reducir PA + ganar músculo** | Aeróbico (150 min) + Fuerza (2×/sem) |
...
|----------|---------------|
| **Aeróbico** | 30 min, 5 días/semana, intensidad moderada (60–70% FC máx) |
...
| Situación | Acción |
|-----------|--------|
| Sarcopenia (pérdida muscular) | Añadir fuerza al aeróbico |
| Diabetes tipo 2 | Combinado: fuerza mejora glucosa |
...
3. **Adherencia variable:** Los programas combinados son más difíciles de mantener
4. **Dosis de fuerza inconsistente:** No hay consenso sobre volumen óptimo para PA
...
|-----------|--------------|
| **Lunes** | 30 min caminata rápida o bicicleta (aeróbico) |
| **Martes** | Entrenamiento de fuerza (tren inferior + core) |
| **Miércoles** | 30 min natación o caminata (aeróbico) |
| **Jueves** | Entrenamiento de fuerza (tren superior) |
| **Viernes** | 30 min bicicleta o caminata (aeróbico) |
...
|-----------------|--------|
| Tu entrenamiento actual | Mantiene masa muscular, fuerza, salud ósea |
| Lo que te falta | 150 min/semana de aeróbico moderado |
