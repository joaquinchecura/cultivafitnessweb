// app/cookies/page.tsx (o pages/cookies.tsx)
import { Leaf, Cookie, Settings, Sliders, Info } from 'lucide-react';
import { Metadata } from 'next';

export const metadata: Metadata = {
  title: 'Política de Cookies | Cultiva Fitness',
  description: 'Cómo usamos cookies y tecnologías similares en cultivafitness.app y nuestras apps.',
};
